...
all_p <- g_obs10 / g_pred10 / g_pred10sesam / g_over10 / g_over10sesam / g_cor10 / g_cor10sesam
  ...
  #                                                         hjust = 0.5)))
#Save
ggsave(filename = "Results/Images/H1_maps/10thr and ranking.png",  all_p, dpi = 600,
       units = "px", width = 2600,
       height = 3100, scale = 6)
...
#
# ggsave(filename = "Results/Images/H1_maps/10thr and ranking_v3.png", all_plots, dpi = 600,
#        units = "px", width = 3200,
#        height = 2500, scale = 3.1)

ggsave(filename = "Results/Images/H1_maps/Figure 2.png", all_plots, dpi = 600,
       units = "px", width = 3400,
...
g2f
#Save
filename <- paste0("Results/Images/H2_boxplots/Boxplot_10thr_SESAM.png")
...
ggsave(filename = "Results/Images/H2_boxplots//Figure 3.png", all_plots, dpi = 600,
       units = "px", width = 2900,
...
g3f
#Save
filename <- paste0("Results/Images/H3_Dissimilarity/10_ranking_Models_v1.png")
...
g3g
#Save
filename <- paste0("Results/Images/H3_Dissimilarity/Figure 4.png")
